...
setup(
    ...
    url="https://github.com/clinicedc/edc-ltfu",
    license="GPL license, see LICENSE",
    description="HIV, HTN and DM classes for the clinicedc/edc",
    long_description=README,
    zip_safe=False,
    keywords="django edc morbidities hypertension diabetes hiv",
    install_requires=[],
    classifiers=[
